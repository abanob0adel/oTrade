...
export const createOrUpdateTranslation = async (entityType, entityId, language, title, description, content, name = '') => {
  try {
    ...
    const validEntityTypes = ['course','strategy','analysis','webinar','psychology','analyst','testimonial','books','articles','lesson','gold','forex','bitcoin','market-analysis','market-category','market-analysis-update','about-settings','about-team','partner','indicator','expert-advisor','ea-key-feature','ea-recommendation','ea-pro','ea-con','ea-update'];
