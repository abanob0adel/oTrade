...
export const createOrUpdateTranslation = async (entityType, entityId, language, title, description, content) => {
  try {
    ...
    const validEntityTypes = ['course','strategy','analysis','webinar','psychology','analyst','testimonial','books','articles','lesson','gold','forex','bitcoin','market-analysis','market-category'];
